...
Dispatch spellbook:code-reviewer subagent to catch issues before they cascade.
...
Use Task tool with spellbook:code-reviewer type, fill template at `code-reviewer.md`
...
[Dispatch spellbook:code-reviewer subagent]
